...
/**
  ...
  */
function createContract({ from, data, value, gasLimit, signed }, txRunner, callbacks, finalCallback) {
...
/**
  ...
  * @param {Function} finalCallback    - last callback.
  */
function callFunction({ from, to, data, value, gasLimit, signed }, funAbi, txRunner, callbacks, finalCallback) {
