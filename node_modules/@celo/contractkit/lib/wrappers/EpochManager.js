...
class EpochManagerWrapper extends BaseWrapperForGoverning_1.BaseWrapperForGoverning {
    constructor() {
        ...
        this.finishNextEpochProcessTx = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const electedGroups = new Set(yield Promise.all(elected.map((validator) => __awaiter(this, void 0, void 0, function* () { return validators.getValidatorsGroup(validator); }))));
